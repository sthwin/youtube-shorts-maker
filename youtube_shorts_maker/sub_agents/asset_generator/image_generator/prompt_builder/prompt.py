...
- **Text margins**: Ensure text has sufficient margins (minimum 80-100px from all edges) to prevent cropping at borders
- **Text positioning strategy**: Position text to avoid covering the main subject/focal point of the image. Place text in areas with less visual importance (e.g., top or bottom thirds) to maximize visibility of the main image content
