...
async def generate_narrations(
    ...
    """
    Generate narrations audio for each scene using OpenAI TTS API
    ...
    return {
        "success": True,
        "narrations": generate_narrations,
        "total_narrations": len(generate_narrations),
    }
